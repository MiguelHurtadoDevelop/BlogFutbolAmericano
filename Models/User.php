...
class User
{
     ...
     * @param string      $rol
     */
    public function __construct(string $id, string $nombre, string $apellidos, string $email, string $password, ?string $fecha = null, string $rol)
    {
        $this->id = $id;
        $this->nombre = $nombre;
    ...
    public function create(): bool
    {
        ...
        try {
            $ins = $this->db->prepara("INSERT INTO usuarios (id, nombre, apellidos, email, password, fecha, rol) values (:id, :nombre, :apellidos, :email, :password, :fecha, :rol)");
    ...
    public function update(): bool
    {
        ...
        try {
            $ins = $this->db->prepara("UPDATE usuarios SET nombre=:nombre, apellidos=:apellidos, email=:email, password=:password, fecha=:fecha, rol=:rol WHERE id=:id");
