...
<body>
<header>
    <h1>Blog de Fútbol Americano</h1>
    <?php 
    ...
    <nav id="menu_cat">
        <ul>
            <li><a href="<?= BASE_URL ?>registro/mostrarRegistros/">Inicio</a></li>
            <?php 
            // Itera sobre las categorías para mostrarlas en el menú
            foreach ($categorias as $categoria): ?>
                <li>
                    <a href="<?= BASE_URL ?>registro/mostrarRegistros/?categoriaId=<?= $categoria['id'] ?>">
                        <?= $categoria['nombre'] ?>
                    </a>
                </li>
            <?php endforeach; ?>
